import { Card, CardHeader, CardTitle, CardContent } from '@/ui/operational-dashboard/ui/card';
      ...
      <CardContent>
        <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed bg-muted/25 p-12 text-center h-[450px]">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Cargue archivos de datos para generar grÃƒÂ¡ficos y tablas de anÃƒÂ¡lisis.
          </p>
        </div>
      </CardContent>
    </Card>
